<?php
	$page_title = "Ruumide broneerimine";
	$page_file = "ruumid.php";
...
<?php require_once($_SERVER['DOCUMENT_ROOT'] . "/views/_templates/sidebar.php"); ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Ruumid
            <small>Ruumide broneerimine</small>
          </h1>
        </section>
            ...
            <div class="col-sm-3">
              ...
              <div class="box box-danger">
                ...
                <div class="box-body">
                  ...
                  <label for="select-1">Vali ruum</label>
                  <select id='type' class="form-control">
                    <option> ----- </option>
                    <option value='1'>Koosolekute ruum</option>
                    <option value='2'>Volikogu saal</option>
                    <option value='3'>Rae koolimaja</option>
                  </select>
...
<script src="js/timetable_ruumid.js"></script>