   ...
   <?php $_SESSION['msg_seen'] = true; endif; ?>
      ...
      <div class="col-sm-6">
        ...
        <div class="form-group">
    	  <label for="select-1">Minu asutused</label>
    	   <?=$Objects->fillMySelect();?>
    	  </div>
      ...
      <div class="box box-danger">
        <div class="box-header with-border">
          <h3 class="box-title">Hoolduslepingud</h3>
          <div class="box-tools pull-right">
            <!-- Buttons, labels, and many other things can be placed here! -->
            <!-- Here is a label for example -->
            <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
        ...
        <div class="box-footer">
          ...
          -->
          <form id="doc_form" name="form" action="upload.php" method="POST" enctype="multipart/form-data" >
